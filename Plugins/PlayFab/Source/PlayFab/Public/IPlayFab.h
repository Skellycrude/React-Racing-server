...
public:
    ...
    */
    ...
    const FString SdkVersion = "0.0.180809";
    const FString BuildIdentifier = "jbuild_unrealblueprintsdk_2";
    const FString VersionString = "UnrealCppSDK-0.0.180809";
    ...
    */
    ...
    inline FString getEntityToken()
    {
        return EntityToken;
    }
    inline void setEntityToken(FString NewEntityToken)
    {
