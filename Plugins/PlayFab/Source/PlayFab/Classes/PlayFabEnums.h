...
{
    pfenum_title UMETA(DisplayName = "title"),
    pfenum_master_player_account UMETA(DisplayName = "master_player_account"),
    pfenum_title_player_account UMETA(DisplayName = "title_player_account"),
    pfenum_character UMETA(DisplayName = "character"),
    pfenum_group UMETA(DisplayName = "group"),
    pfenum_service UMETA(DisplayName = "service"),
};
